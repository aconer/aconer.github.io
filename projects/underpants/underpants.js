...
*   _.identity({a: "b"}) === {a: "b"}
*/
_.identity = function(value){ //pass thru dummy function
   return value; 
};
...
/*_.pluck = function(array, property){
    var output = [];
    _.map(array, function(array, i, element){
...
/*
*_.reduce = function(collection, function, seed){
    var newArray = [];
    each(collection, function(value, postion, collection){
